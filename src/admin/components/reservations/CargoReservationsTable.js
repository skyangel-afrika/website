...
export default function CargoReservationsTable() {
  ...
  useEffect(() => {
    const q = query(collection(db, 'cargo-reservations'), orderBy('createdAt', 'desc'));
        ...
        <Table size="small" aria-label="ccg">
          <TableHead>
            <TableRow>
              ...
              <TableCell align="right">Cargo To</TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
            {reservations
                ...
                <React.Fragment key={uuid()}>
                  ...
                  >
                    ...
                    <TableCell component="th" scope="row">
                      {reservation.reservation_data.name}
                    </TableCell>

                    <TableCell component="th" scope="row">
                      {reservation.reservation_data.from}
                    </TableCell>
                    <TableCell align="right">{reservation.reservation_data.to}</TableCell>
                  </TableRow>
                          ...
                          <Table size="small" aria-label="purchases">
                            ...
                            <TableBody>
                              <TableRow key={uuid()}>
                                ...
                                <TableCell>
                                  {reservation.other_data.description}
                                </TableCell>
                              </TableRow>
                            </TableBody>
                          </Table>
