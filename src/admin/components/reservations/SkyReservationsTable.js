...
export default function SkyReservationsTable() {
  ...
  useEffect(() => {
    const q = query(collection(db, 'skyreservations'), orderBy('createdAt', 'desc'));
              ...
              .map((reservation, index) => (
                <React.Fragment key={uuid()}>
                  ...
                  >
                    ...
                    <TableCell component="th" scope="row">
                    {reservation.reservation_data.skyEvent}
                    </TableCell>
                  </TableRow>
